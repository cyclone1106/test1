<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="chitietdethi.aspx.cs" Inherits="chitietdethi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="tieudekiemtra" ><p>TEST</p></div>
    <div class="baikiemtra" id="kiemtra" runat="server">
            <div class="cauhoi"><p>
                <asp:Label ID="txt_dethi" runat="server"></asp:Label></p></div>
             <br />
         ...
         <asp:Repeater ID="Rpt_nghe_hinhanh" runat="server">
              ...
              <div class="chitietcauhoi"> 
                ...
                <p>You will hear a question or statement and three responses spoken in English. They will not appear on your screen and will be spoken only one time. Select the best response to the question or statement and click on the letter (A), (B), or (C) in the answer space provided.</p>
              ...
              <div class="chitietcauhoi"> 
                  ...
                  <div class="dapan">
                          ...
                          <div class="traloi1"><asp:RadioButton ID="RadioButton5" runat="server"  GroupName="dapan'<%=id++ %>'"  /><span >B.<asp:Label ID="B" runat="server"></asp:Label></span></div>
                          <div class="traloi1"><asp:RadioButton ID="RadioButton6" runat="server"  GroupName="dapan'<%=id++ %>'"  /><span >C.<asp:Label ID="C" runat="server"></asp:Label></span></div>
                              <div class="traloi1"><asp:RadioButton ID="RadioButton2" runat="server"  GroupName="dapan'<%=id++ %>'"  /><span >D.<asp:Label ID="D" runat="server"></asp:Label></span></div>
       ...
       <div id="phandoc" runat="server" class="phandoc">
        <br />
         ...
         <div id="dongho1"></div>
                ...
                <p>A word or phrase is missing in each of the following sentences. Select the best response to each question and click on the letter (A), (B), (C), or (D) in the answer space provided.</p>
           ...
           <p>In this part you will read a selection of texts, such as magazine and newspaper articles, letters, and advertisements. Each text is followed by several questions. Select the best answer for each question in the answer space provided.</p>
            ...
            <asp:Repeater ID="rpt_doanvandoi" runat="server">
              <ItemTemplate>
                <p><%#Eval("Phancauhoi") %></p>
              <div class="chitietcauhoi"> 
                          <span><b>Question <%=iddocdoanvan++%>.  <%#Eval("Noidung") %></b></span>
