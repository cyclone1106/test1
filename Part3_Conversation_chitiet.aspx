<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Part3_Conversation_chitiet.aspx.cs" Inherits="Part_3_Conversation_chitiet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="tieudenguphap">
        <p><asp:Label ID="txt_tieude" runat="server">PART 3: CONVERSATION</asp:Label></p>
    </div>
         <div class="tieudenguphap">
        <p><asp:Label ID="Label1" runat="server"> <asp:Label ID="txt_dethi" runat="server"></asp:Label></asp:Label></p>
    </div>
            ...
            <div class="cauhoi"><p><asp:Label ID="txt_dethi2" runat="server"></asp:Label></p></div>
                ...
                <div id="Div1" class="start" runat="server">
                    ...
                    <audio controls="controls" style="width:700px" autoplay="autoplay" aria-autocomplete="none"  aria-readonly="true">
                          ...
                          <source src="audio//<%=filenghe %>" type="audio/mp3" onclick="false" aria-readonly="true"  />
                     </audio>
