...
public partial class Part7_Single_Passage_chitiet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string sql_docdientu = "select * from CAUHOI where IDNoidung='SinglePassage'";
            ...
            for (int i = 0; i < Rpt_nghe.Items.Count; i++)
            {
                ...
                string sql = "select * from DAPAN where IDCauhoi ='1_Single_" + (i + 1) + "'";
     ...
     protected void Button1_Click(object sender, EventArgs e)
{
    string id = Request.QueryString["dethi"];
        ...
        for (int i = 0; i < Rpt_nghe.Items.Count; i++)
        {
            string sql_dapan = "select * from CAUHOI where IDNoidung='SinglePassage'";
