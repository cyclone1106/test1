<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Part4_Talk_chitiet.aspx.cs" Inherits="Part4_Talk_chitiet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="tieudenguphap">
        <p><asp:Label ID="txt_tieude" runat="server">PART 4: TALK</asp:Label></p>
    </div>
         <div class="tieudenguphap">
