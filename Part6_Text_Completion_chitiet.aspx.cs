...
public partial class Part6_Incomplete_Sentence_chitiet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string sql_docdientu = "select * from CAUHOI where IDNoidung='TextCompletion'";
            ...
            for (int i = 0; i < Rpt_nghe.Items.Count; i++)
            {
                ...
                try
                {
                    string sql = "select * from DAPAN where IDCauhoi ='1_Com_" + (i + 1) + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < Rpt_nghe.Items.Count; i++)
        {
            string sql_dapan = "select * from CAUHOI where IDNoidung='TextCompletion'";
