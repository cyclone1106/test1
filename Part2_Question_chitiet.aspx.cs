...
public partial class Part2_Question_chitiet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string sql_hinhanh = "select A.IDCauhoi,C.IDNoidungchitiet, A.Phancauhoi, RTRIM(B.Tenfile)as Tenfile,A.Noidung from CAUHOI A, FILES B, CHITIETNOIDUNG C where A.IDNoidung='Question' and C.IDNoidungchitiet=A.IDNoidung and A.IDFile=B.IDFile and A.Made='" + id + "' order by A.IDCauhoi ASC";
            ...
            for (int i = 0; i < Rpt_nghe.Items.Count; i++)
            {
                ...
                try
                {
                    string sql = "select * from DAPAN where IDCauhoi ='1_Ques_" + (i + 1) + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < Rpt_nghe.Items.Count; i++)
        {
            string sql_dapan = "select * from CAUHOI where IDNoidung='Question'";
