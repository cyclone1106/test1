...
public partial class chitietdethi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txt_dethi.Text = tb_dethi.Rows[0][0].ToString();
            ...
            string sql_hinhanh = "select A.IDCauhoi,C.IDNoidungchitiet, A.Phancauhoi, RTRIM(B.Tenfile)as Tenfile,A.Noidung from CAUHOI A, FILES B, CHITIETNOIDUNG C where A.IDNoidung='Photographstest' and C.IDNoidungchitiet=A.IDNoidung and A.IDFile=B.IDFile and Made='"+ id +"' order by A.IDCauhoi ASC";
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='Photographstest'";
                    ...
                    string sql = "select * from DAPAN where IDCauhoi ='" + tb_dapan.Rows[i]["IDCauhoi"].ToString() + "'";
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='Questiontest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);
                ...
                string sql_hoithoai = "select A.IDCauhoi,C.IDNoidungchitiet, A.Phancauhoi, RTRIM(B.Tenfile)as Tenfile,A.Noidung from CAUHOI A, FILES B, CHITIETNOIDUNG C where A.IDNoidung='Conversationtest' and C.IDNoidungchitiet=A.IDNoidung and A.IDFile=B.IDFile and Made='" + id + "' order by A.IDCauhoi ASC";
                ...
                {
                   string sql_dapan="select * from CAUHOI where IDNoidung='Conversationtest'";
                    DataTable tb_dapan=ketnoi.getData(sql_dapan);
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='Talktest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);
                    ...
                    b.Text = tb.Rows[1]["NDDA"].ToString();
                    c.Text = tb.Rows[2]["NDDA"].ToString();
                    c.Text = tb.Rows[3]["NDDA"].ToString();
                }
            //Phần đọc
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='Sentencestest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='TextCompletiontest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);
                ...
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='SinglePassagetest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);
                ...
                rpt_doanvandoi.DataSource = ketnoi.getData(sql_docdoanvan1);
                rpt_doanvandoi.DataBind();
                for (int i = 0; i < rpt_doanvandoi.Items.Count; i++)
                {
                    string sql_dapan = "select * from CAUHOI where IDNoidung='DoublePassagetest'";
                    DataTable tb_dapan = ketnoi.getData(sql_dapan);

                    Label a = (Label)rpt_doanvandoi.Items[i].FindControl("A");
                    Label b = (Label)rpt_doanvandoi.Items[i].FindControl("B");
                    Label c = (Label)rpt_doanvandoi.Items[i].FindControl("C");
                    Label d = (Label)rpt_doanvandoi.Items[i].FindControl("D");
                    try
                    {
                        string sql = "select * from DAPAN where IDCauhoi ='" + tb_dapan.Rows[i]["IDCauhoi"].ToString() + "'";
                        DataTable tb = ketnoi.getData(sql);
    ...
    protected void Button1_Click(object sender, EventArgs e)
{
    ...
    string id = Request.QueryString["dethi"];
        ...
        for (int i = 0; i < Rpt_nghe_hinhanh.Items.Count; i++)
        {
            ...
            string sql = "select b.NDDA, b.DA from CAUHOI a, DAPAN b where a.IDCauhoi=b.IDCauhoi and b.IDCauhoi='" + tb_dapan.Rows[i]["IDCauhoi"].ToString() + "' and Made='" + id + "'";
            DataTable tb = ketnoi.getData(sql);
        ...
        for (int i = 0; i < rpt_nghehoithoai.Items.Count; i++)
        {
            ...
            RadioButton D = (RadioButton)rpt_nghehoithoai.Items[i].FindControl("RadioButton2");
        ...
        for (int i = 0; i < rpt_nghedoanvan.Items.Count; i++)
        {
            ...
            RadioButton D = (RadioButton)rpt_nghedoanvan.Items[i].FindControl("RadioButton2");
            string sql = "select b.NDDA, b.DA from CAUHOI a, DAPAN b where a.IDCauhoi=b.IDCauhoi and b.IDCauhoi='" + tb_dapan.Rows[i]["IDCauhoi"].ToString() + "'";
            DataTable tb = ketnoi.getData(sql);
        ...
        for (int i = 0; i < rpt_doanvandoi.Items.Count; i++)
        {
            string sql_dapan = "select * from CAUHOI where IDNoidung='DoublePassagetest'";
            DataTable tb_dapan = ketnoi.getData(sql_dapan);
            RadioButton A = (RadioButton)rpt_doanvandoi.Items[i].FindControl("RadioButton4");
            RadioButton B = (RadioButton)rpt_doanvandoi.Items[i].FindControl("RadioButton5");
            RadioButton C = (RadioButton)rpt_doanvandoi.Items[i].FindControl("RadioButton6");
            RadioButton D = (RadioButton)rpt_doanvandoi.Items[i].FindControl("RadioButton1");
            string sql = "select b.NDDA, b.DA from CAUHOI a, DAPAN b where a.IDCauhoi=b.IDCauhoi and b.IDCauhoi='" + tb_dapan.Rows[i]["IDCauhoi"].ToString() + "'and Made='" + id + "'";
            DataTable tb = ketnoi.getData(sql);
    ...
    string diemdoc = "select Sodiem from DIEMDOC where IDCaudung='"+socaudungdoc+"'";
    DataTable tb_diemdoc = ketnoi.getData(diemdoc);

    string diemnghe = "select Sodiem from DIEMNGHE where IDCaudung='"+socaudungnghe+"'";
    ...
    Response.Write("<script> alert('Bạn đã đúng: + Phần nghe: " + a + " - " + tb_diemnghe.Rows[0][0]+" Phần đọc: "+socaudungdoc+" - "+tb_diemdoc.Rows[0][0]+" - Tổng điểm của bạn là: " + (Int32.Parse(tb_diemdoc.Rows[0][0].ToString())+Int32.Parse(tb_diemnghe.Rows[0][0].ToString())) + "  điểm - Thời gian làm bài: " +  Tongthoigian+ " Phút') </script>");
    phandoc.Visible = false;
    phannghe.Visible = false;
