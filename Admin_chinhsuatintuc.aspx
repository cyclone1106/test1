<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Admin_chinhsuatintuc.aspx.cs" Inherits="Admin_chinhsuatintuc" %>
        ...
        <table class="admin_cauhoi">
            <tr>
             ...
             <tr>
              ...
              <tr>
                <td>Nội dung</td>
                <td colspan="2"> <CKEditor:CKEditorControl ID="txt_doanvan" runat="server" BasePath="~/ckeditor" Height="411px" Width="794px"></CKEditor:CKEditorControl>  </td>
            </tr>
