<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Part1_Photographs_chitiet.aspx.cs" Inherits="Part1_Photographs_chitiet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="tieudenguphap">
        <p><asp:Label ID="txt_tieude" runat="server">PART 1: PHOTOGRAPHS</asp:Label></p>
    </div>
         <div class="tieudenguphap">
